---
title: "Lab 2 - Modern Cyber"
linkTitle: "2. Lab 2 -Modern Cyber"
weight: 1
#archetype: "chapter"
---

## Lab overview
This is a bit of a palette cleanser for the unfortunate souls who have to sit through a four session. It is meant to demonstrate the modern attack surface area and contrast it against traditional cyber protections...but it is also just an excuse to hack an AI model. In this lab you will access to a chatbot powered by a Large Language Model (LLM). The chatbot interface will be Open WebUI backed by a Ollama model based on [llama3.2](https://ollama.com/library/llama3.2).
...
**(Ideally your intructor had you go through these steps prior to this lab. If not, it may take a few minutes to set up!)**
